...
public class EscalationReminderDto {
    ...
    public EscalationReminderDto() {
        super();
    }

    public EscalationReminderDto(Long id, boolean enabled, DayOfWeek day, LocalTime time, 
    ...
    public String toString() {
        return "EscalationReminderDto [id=" + id + ", enabled=" + enabled + ", day=" + day + ", time=" + time
