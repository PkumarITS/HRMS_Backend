...
public class ApprovalReminderDto {
    ...
    public ApprovalReminderDto(Long id, boolean enabled, DayOfWeek day, LocalTime time, ReminderLevel level,
    ...
    public String toString() {
        return "ApprovalReminderDto [id=" + id + ", enabled=" + enabled + ", day=" + day + ", time=" + time +
