...
public class ApprovalReminderDto {
    ...
    public ApprovalReminderDto(Long id, boolean enabled, String day, String time, ReminderLevel level,
	...
	public String toString() {
		return "ApprovalReminderDto [id=" + id + ", enabled=" + enabled + ", day=" + day + ", time=" + time + ", level="
